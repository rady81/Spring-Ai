package com.ailabs.prompttemplate.controller;
...
public class ChatController {
   ...
   //http://localhost:8080/claude-ai/chat
    @PostMapping("/ollamallm-prompt-ai/chat")
...
//        return new Output(response);
    ...
    Output suggestTitles(@RequestBody @Valid TitleSuggestionsRequest request) {
        ...
        Map<String, Object> vars = Map.of("topic", request.topic(), "count", request.count());
