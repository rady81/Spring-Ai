...
import com.ailabs.prompttemplate.controller.ChatController;
...
class PromptTemplateAiApplicationTests {
    @Autowired
    MockMvcTester mockMvcTester;

    @Test
    void chat() {
        MvcTestResult testResult = mockMvcTester.post().uri("/ollamallm-prompt-ai/chat")
