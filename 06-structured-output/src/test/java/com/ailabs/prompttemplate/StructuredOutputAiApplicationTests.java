package com.ailabs.prompttemplate;

import com.ailabs.structuredoutput.controller.StructuredOutputController;
...
class StructuredOutputAiApplicationTests {@Autowired
MockMvcTester mockMvcTester;

    @Test
    void chat() {
        MvcTestResult testResult = mockMvcTester.post().uri("/ollamallm-structured-ai/chat")
